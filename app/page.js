...
export default function Home(){
  return <>
    <header className="header">
      <Link href="#inicio" className="brand"><span className="heartMark">♥</span><span>HUELLA SOCIAL<small>FUNDRAISING</small></span></Link>
    ...
    <main>
      <section id="inicio" className="hero">
        <div className="heroCopy">
          <p className="eyebrow">Fundraising Face to Face · Querétaro</p>
          <h1>Conversaciones que dejan <span>huella.</span></h1>
          <p className="lead">Somos una agencia queretana especializada en fundraising Face to Face que conecta personas con causas que transforman vidas.</p>
          <div className="actions"><Link href="#reunion" className="button primary">Agenda una reunión</Link><Link href="#modelo" className="button secondary">Conoce nuestro modelo</Link></div>
          <div className="trustRow"><span>Agencia queretana</span><span>Captación Face to Face</span><span>Relaciones duraderas</span></div>
        </div>
        <div className="heroImage"><Image src="/images/hero.jpeg" alt="Promotores de Huella Social" fill priority sizes="(max-width: 900px) 100vw, 54vw" /></div>
      </section>
